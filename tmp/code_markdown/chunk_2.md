...
### src/types/document-pipeline.ts
...
### src/test/unit-detection.test.ts
...
### src/test/full-document-pipeline-canon.test.ts
...
### src/test/full-document-pipeline-ui.test.tsx
...
### src/test/full-document-pipeline-artifact.test.ts
...
### src/test/parser-integration.test.ts
...
### src/test/name-mappings.test.ts
...
### src/test/npc-parser-html.test.ts
